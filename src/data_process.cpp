...
bool DataProcess::processObjectListMessage(char * in, RadarObjectList *o_list)
{
    ...
    //     count++; 
    //     std::cout << "test:" << (uint16_t)(* in) << " count:"<< count << std::endl;
    //     in +=  1;
    // }
    ...
    // std::cout << "objectLists's serviceID:" << o_list->serviceID << std::endl;
    // std::cout << "objectLists's MethodID:" << o_list->MethodID << std::endl;
    return true;
}
...
bool DataProcess::processDetectionListMessage(char *in, RadarDetectionList *d_list)
{
    ...
    // std::cout << "detection's serciveID:" << d_list->serviceID << std::endl;
    // std::cout << "detection's methodID:" << d_list->MethodID << std::endl;
    // std::cout << "detection's Timestamp Nanoseconds: " << d_list->Timestamp_Nanoseconds << std::endl; 
