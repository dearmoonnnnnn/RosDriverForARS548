...
int main(int argc, char **argv)
{
    ...
    acc_lateral_cog_pub = nh.advertise<ars548_process::AccelerationLateralCog>("/ars548_process/acc_lateral_cog", 10);
    acc_longitudinal_cog_pub = nh.advertise<ars548_process::AccelerationLongitudinalCog>("/ars548_process/acc_longitudinal_cog", 10);
    characteristic_speed_pub = nh.advertise<ars548_process::CharacteristicSpeed>("/ars548_process/characteristic_speed", 10);
    driving_direction_pub = nh.advertise<ars548_process::DrivingDirection>("/ars548_process/driving_direction", 10);
    steering_angle_pub = nh.advertise<ars548_process::SteeringAngleFrontAxle>("/ars548_process/steering_angle", 10);
    velocity_vehicle_pub = nh.advertise<ars548_process::VelocityVehicle>("/ars548_process/velocity_vehicle", 10);
    yaw_rate_pub = nh.advertise<ars548_process::YawRate>("/ars548_process/yaw_rate", 10);
